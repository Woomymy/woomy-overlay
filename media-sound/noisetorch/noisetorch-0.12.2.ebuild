...
SRC_URI="
	...
	https://github.com/noisetorch/c-ringbuf/archive/${RINGBUF_COMMIT}.tar.gz -> submod-ringbuf.tar.gz
	https://github.com/noisetorch/rnnoise/archive/${RNNOISE_COMMIT}.tar.gz -> submod-rnnoise.tar.gz
"
